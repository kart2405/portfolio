...
const projects = [
  ...
  {
    title: 'API Gateway with Rate Limiting & JWT Validation',
    description: 'A high-performance gateway that acts as the guardian of your microservices architecture. Implements intelligent rate limiting and robust authentication to protect your APIs from abuse while ensuring seamless user experience.',
    icon: <FiServer className="w-8 h-8" />,
    color: 'from-green-500 to-green-600',
    bgColor: 'bg-green-50 dark:bg-green-900/20',
    status: 'Completed',
    technologies: ['Go', 'Redis', 'PostgreSQL', 'Docker', 'Gin', 'JWT'],
